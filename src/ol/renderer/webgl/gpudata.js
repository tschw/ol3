...
/**
 * Emit vertices with redundant coordinates distinguished by their
 * control flags.
 *
 ...
 * @param {... number} var_args Flags.
 */
ol.renderer.webgl.gpuData.emitVertices =
    function(vertices, x, y, var_args) {
  ...
  for (var i = 3, n = arguments.length; i < n; ++i) {
    vertices.push(xCoarse, yCoarse, x, y, arguments[i]);
  }
};
